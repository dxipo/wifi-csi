...
data = dict(
    ...
    train=dict(
        ...
        use_offline_stft=True,
        offline_stft_dir='csi_stft_offline',
        offline_stft_ext='.npy',
        stft_cfg=dict(
            nperseg=8,
            noverlap=4,
            nfft=16
...
work_dir = '/home/xl/CSI/Person-in-WiFi-3D-repo/result/42_wifipose_2d_baseline_STFT_offline'
auto_resume = False
#gpu_ids = range(0, 3)
gpu_ids = range(0, 1)
