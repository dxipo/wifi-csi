...
data = dict(
    ...
    train=dict(
        ...
        dataset_root=
        '/home/xl/CSI/Person-in-WiFi-3D-repo/data/wifipose/all_single_train_data_hold_out_sdp_offline_power_xfall',
        offline_sdp_dir='csi_sdp_offline',
        offline_sdp_ext='.npy',
        sdp_layout='wtn',
        stft_cfg=dict(nperseg=8, noverlap=4, nfft=16),
        pipeline=[
            dict(
                type='opera.DefaultFormatBundle',
                extra_keys=['gt_keypoints', 'gt_labels', 'gt_token']),
    ...
    val=dict(
        type='opera.WifiPoseDataset',
        dataset_root=
        '/home/xl/CSI/Person-in-WiFi-3D-repo/data/wifipose/all_single_test_data_hold_out_sdp_offline_power_xfall',
        offline_sdp_dir='csi_sdp_offline',
        offline_sdp_ext='.npy',
        sdp_layout='wtn',
        stft_cfg=dict(nperseg=8, noverlap=4, nfft=16),
