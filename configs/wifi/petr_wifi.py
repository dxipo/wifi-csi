...
data = dict(
    ...
    train=dict(
        ...
        dataset_root='/home/xl/CSI/Person-in-WiFi-3D-repo/data/wifipose/all_single_train_data_hold_out_sdp140_imagelike_centerctx_n30_power_xfall',
        offline_sdp_dir='csi_sdp140_imagelike_lagwindow_offline',
        offline_sdp_ext='.npy',
        sdp_layout='hwc',
        stft_cfg=dict(
            nperseg=8,
    ...
    val=dict(
        type='opera.WifiPoseDataset',
        dataset_root='/home/xl/CSI/Person-in-WiFi-3D-repo/data/wifipose/all_single_test_data_hold_out_sdp140_imagelike_centerctx_n30_power_xfall',
        offline_sdp_dir='csi_sdp140_imagelike_lagwindow_offline',
        offline_sdp_ext='.npy',
        sdp_layout='hwc',
        stft_cfg=dict(
...
work_dir = '/home/xl/CSI/Person-in-WiFi-3D-repo/result/49_wifipose_2d_baseline_SDP140_no_translator_lagwindow_centerctx'
auto_resume = False
#gpu_ids = range(0, 3)
gpu_ids = range(0, 1)
